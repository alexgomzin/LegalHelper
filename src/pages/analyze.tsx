  ...
  const PaymentModal = () => (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-md w-full">
        <h2 className="text-2xl font-bold mb-4">You Need Credits to Continue</h2>
        <p className="mb-6">
          You don't have any credits remaining to analyze this document. 
          You can purchase a single analysis for $1.50 or visit our pricing page for better deals.
        </p>
